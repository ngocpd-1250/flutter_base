...
class _$MovieDataImpl implements _MovieData {
  ...
  @override
  String toString() {
    return 'MovieData(id: $id, adult: $adult, title: $title, overview: $overview, popularity: $popularity, posterPath: $posterPath, backdropPath: $backdropPath, voteCount: $voteCount, voteAverage: $voteAverage, video: $video, releaseDate: $releaseDate)';
  }
...
abstract class _MovieData implements MovieData {
  const factory _MovieData(
      ...
      final double voteAverage,
      final bool video,
      final String releaseDate}) = _$MovieDataImpl;
